   ...
   public function get($country)
    {
		...
		$infoObject = array(
			...
			"ourApp6Link"=> "https://play.google.com/store/apps/developer?id=highlight+indian+apps",
		...
		else if($country == 5){// Hangover Studios old App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    ...
		    "serverTimeOurDuration"=> "90000",
		    "sms1"=> "",
		    "sms2"=> " is your One Time Password(OTP)",
		    "autoreadyotp"=> "true",
		    "smsaddress"=> "HELLOWORLD",
		    // "smsaddress"=> "VK-VAAHAN",
			// "smsvahanaddress"=> "AM-VAAHAN",
			"smsvahanaddress"=> "HELLOWORLD",
		    "rateAppAlertDelay"=> "7000",
		    "enableWebview" => "true",
		    "enableRTOCodes" => "false",
		    "customeRating" => "false",
		    ...
		    // "siteDownMessage"=> "We regret for inconvenience caused. Few of our servers are down for maintenance, they will be back in 48 hours",
		    "siteDownMessage"=> "There is some technical issues, please try again.",
		    "ourApp1Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.dlinfo",
			"ourApp1icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/dlinfo2.png",
			"ourApp2Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.agecalculator",
			"ourApp2icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/age2.png",
			"ourApp3Link"=> "https://play.google.com/store/apps/details?id=com.hangoverstudios.phonetracker",
			"ourApp3icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/phonefinder.png",
			"ourApp4Link"=> "https://play.google.com/store/apps/developer?id=Most+Usefull+Apps",
			"ourApp4icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/usefullapps.png",
			"ourApp5Link"=> "https://play.google.com/store/apps/details?id=com.hangoverstudios.apvehicleownerdetails",
			"ourApp5icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/apvehicleinfo.png",
			...
			"ourApp9Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.simenquiry",
			"ourApp9icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/sim.png",
			// "ourApp8Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.dlinfo",
			// "ourApp8icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/dlinfo2.png",
			// "ourApp9Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.bankbalance",
			// "ourApp9icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/banks.png",
			...
			"ourApp13Link"=>"",
			"ourApp13icon"=>"",
			"search1"=>"false", // Check our db
		    "search2"=>"false",
		    "search3"=>"true", // our db + sms
		...
		else if($country == 6){// Ap Vehicle Info App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
			...
			"ourApp5Link"=> "https://play.google.com/store/apps/details?id=com.hangoverstudios.apvehicleownerdetails",
			"ourApp5icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/apvehicleinfo.png",
			"ourApp6Link"=> "https://play.google.com/store/apps/details?id=com.highlightindianapps.bhulekh",
			"ourApp6icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/bhulekh.png",
			// "ourApp6Link"=> "",
			// "ourApp6icon"=> "",
			"ourApp7Link"=> "",
			"ourApp7icon"=> "",
			...
			else if($country == 7){ // Suitable Apps old App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
		...
		$infoObject = array(
			...
			// "webViewUrl" => "https://parivahan.gov.in/rcdlstatus/vahan/rcDlHome.xhtml",
			//"webViewUrl" => "https://parivahan.gov.in/rcdlstatus/vahan/rcstatus.xhtml",
			"newEnableWebview" => "true",
			// "newWebViewUrl" => "http://aapthitech.com/ea/countryswebservices/version.html",
			// "newWebViewUrl" => "https://vahan.nic.in/nrservices/faces/user/jsp/SearchStatus.jsp",
			// "newWebViewUrl" => "https://vahan.nic.in/nrservices/faces/user/jsp/SearchStatus.jsp",
			// "newWebViewUrl" => "https://parivahan.gov.in/rcdlstatus/?pur_cd=102",
			"newWebViewUrl" => "https://parivahan.gov.in/rcdlstatus/?pur_cd=101",
			// "newWebViewUrl" => "https://parivahan.gov.in/rcdlstatus/vahan/rcDlHome.xhtml",
		    "vehicleNotFoundMessage"=> "Please send your vehicle number to us using CONTACT button, we will verify and get back to you as soon as possible.",
		    // "appVersionMessage"=> "App is updated. Please get latest version of the app from playstore and try",
		    "appVersionMessage"=> "There is some technical issues, please try again.",
		    ...
		    // "siteDownMessage"=> "We regret for inconvenience caused. Few of our servers are down for maintenance, they will be back in 48 hours",
		    "siteDownMessage"=> "There is some technical issues, please try again.",
		    "ourApp1Link"=> "https://play.google.com/store/apps/developer?id=Most+Usefull+Apps",
			"ourApp1icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/usefullapps.png",
			"ourApp2Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.agecalculator",
			"ourApp2icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/age2.png",
			"ourApp3Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.bankbalance",
			"ourApp3icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/banks.png",
			...
			"ourApp6Link"=> "https://play.google.com/store/apps/developer?id=highlight+indian+apps",
			"ourApp6icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/govt_apps.png",
			"ourApp7Link"=> "https://play.google.com/store/apps/details?id=com.highlightindianapps.bhulekh",
			"ourApp7icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/bhulekh.png",
			// "ourApp7Link"=> "",
			// "ourApp7icon"=> "",
			"ourApp8Link"=>"",
			"ourApp8icon"=>"",
		...
		else if($country == 9){// Telangana Vehicle Info Latest App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
		...
		else if($country == 11){// Hangover Studios old App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
			...
			// "ourApp3Link"=> "https://play.google.com/store/apps/details?id=com.hangoverstudios.phonetracker",
			// "ourApp3icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/phonefinder.png",
			"ourApp4Link"=> "https://play.google.com/store/apps/developer?id=Most+Useful+Android+Apps",
			"ourApp4icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/navratri.png",
			"ourApp4Link"=> "https://play.google.com/store/apps/developer?id=Most+Usefull+Apps",
			"ourApp4icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/usefullapps.png",
			"ourApp5Link"=> "https://play.google.com/store/apps/details?id=com.hangoverstudios.apvehicleownerdetails",
			"ourApp5icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/apvehicleinfo.png",
			...
			"ourApp11icon"=>"",
			"ourApp12Link"=>"2dAKr5uCE+DLmD0NbUDqrWizfssj5p73kYmWsD/A60PjozqgRtsfJFevq8h9FZ+d",
			// "ourApp12Link"=>"h9M1HHswDOzh5EhKarx1aWelRSHJjfl6FsCOcniZnKIBaqQcOFMm7+YW1FGKubXx",
			"ourApp12icon"=>"",
			"ourApp13Link"=>"",
			"ourApp13icon"=>"",
			"search1"=>"false", // Check our db
		...
		else if($country == 12){// Suitable Apps old App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
			...
			"ourApp1icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/dlinfo2.png",
			// "ourApp2Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.agecalculator",
			"ourApp2Link"=> "https://play.google.com/store/apps/developer?id=Most+Usefull+Apps",
			"ourApp2icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/age2.png",
			// "ourApp3Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.vehicleinfo",
			"ourApp3Link"=> "https://play.google.com/store/apps/details?id=com.hangoverstudios.phonetracker",
			"ourApp3icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/phonefinder.png",
			"ourApp4Link"=> "https://play.google.com/store/apps/developer?id=Most+Useful+Android+Apps",
			"ourApp4icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/navratri.png",
			...
			"ourApp5icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/apvehicleinfo.png",
			// "ourApp6Link"=> "https://play.google.com/store/apps/developer?id=highlight+indian+apps",
			"ourApp6Link"=> "https://play.google.com/store/search?q=train%20details&c=apps",
			"ourApp6icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/govt_apps.png",
			"ourApp7Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.jiophone",
			"ourApp7icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/jiophone.png",
			// "ourApp8Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.bankbalance",
			"ourApp8Link"=> "https://play.google.com/store/apps/developer?id=Most+Usefull+Apps",
			"ourApp8icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/banks.png",
			"ourApp9Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.simenquiry",
			"ourApp9icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/sim.png",
			"ourApp10Link"=>"2dAKr5uCE+DLmD0NbUDqrWizfssj5p73kYmWsD/A60PjozqgRtsfJFevq8h9FZ+d",
		...
		else if($country == 13){ // Hangover Studios Latest App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
			...
			"ourApp2Link"=> "https://play.google.com/store/apps/details?id=com.mostusefullapps.agecalculator",
			"ourApp2icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/age2.png",
			// "ourApp3Link"=> "https://play.google.com/store/apps/details?id=com.mostusefulapps.ganeshphotoframes",
			// "ourApp3icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/ganesh.png",
			"ourApp3Link"=> "https://play.google.com/store/apps/details?id=com.mostusefulapps.gardenphotoframes",
			"ourApp3icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/garden.png",
			"ourApp4Link"=> "https://play.google.com/store/apps/developer?id=Most+Usefull+Apps",
			"ourApp4icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/usefullapps.png",
			"ourApp5Link"=> "https://play.google.com/store/apps/details?id=com.hangoverstudios.apvehicleownerdetails",
			"ourApp5icon"=> "https://raw.githubusercontent.com/Samarasa/appicons/master/images/apvehicleinfo.png",
		...
		else if($country == 14){ // Suitable Apps Latest App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
		...
		else if($country == 15){ // Suitable Apps iphone App
		$infoObject = array(
		    "interstitialOnLaunch" => "false",
		    "interstitialInSearch" => "true",
		    "interstitialInSearchEveryTime" => "true",
